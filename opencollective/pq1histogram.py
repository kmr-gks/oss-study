...
plt.tight_layout()
plt.savefig("pq1_contribution_histogram_log.png")
plt.close()
...
plt.title("Distribution of Contributions")
plt.tight_layout()
plt.savefig("pq1_contribution_histogram_linear.png")
plt.close()
...
plt.tight_layout()
plt.savefig("pq1_expense_histogram_log.png")
plt.close()
...
plt.title("Distribution of Expenses")
plt.tight_layout()
plt.savefig("pq1_expense_histogram_linear.png")
plt.close()
