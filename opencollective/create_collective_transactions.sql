...
CREATE TABLE collective_transactions (
    ...
    description TEXT,          -- description from transaction object
    ...
    expense_type TEXT,         -- EXPENSE.type (INVOICE, RECEIPT, GRANT, etc.)
    expense_description TEXT,  -- EXPENSE.description
    expense_tags JSONB         -- EXPENSE.tags (stored as JSON array)
);
